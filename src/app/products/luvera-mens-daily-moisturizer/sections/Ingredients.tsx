    ...
    <div className="border-b border-white/[0.06]">
      ...
      >
        ...
        <span
          ...
          style={{
            borderColor:     isOpen ? 'rgb(192, 132, 252 / 0.5)' : 'rgba(255,255,255,0.1)',
            backgroundColor: isOpen ? 'rgb(192, 132, 252 / 0.08)' : 'transparent',
            color:           isOpen ? 'rgb(192, 132, 252)'        : 'rgba(255,255,255,0.3)',
